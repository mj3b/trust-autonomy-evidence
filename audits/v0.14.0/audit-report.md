# v0.14.0 Chain-of-Evidence Integrity Audit

**Audit date:** 2026-08-13

**Status:** `PASS_WITH_EXCEPTIONS`

**Scope:** Thirty-two material claims declared in TAE-COE-V0.14.0, including the closed 13-source proposition-review gate, five bounded manuscript permissions, and the closed direct-query screening overlay. Independent validity, 980 retrieval outcomes, authenticated database coverage, the 177-record backward-reference stratum, and institutional transfer remain outside the completed evidence base.

## Decision

The declared v0.14 claim set passes its executable integrity controls with four published exceptions. All 13 close-source proposition decisions resolve to their frozen input, ledger, locators, fitness states, attestation, bibliography, and manuscript citations. Five bounded propositions have permission, two sources remain background-only, and six remain quarantined. The direct-query overlay closes screening while preserving zero source-content permission. The result supplies no independent reliability, originality, institutional-transfer, or completed systematic-search finding.
...
| specification_violation | pass | 32 | 32 | 0 | 0 |
| reference_verification | pass | 32 | 32 | 0 | 0 |
| method_code_alignment | pass | 9 | 9 | 0 | 0 |
| evidence_fitness_and_dependency_closure | pass_with_exceptions | 32 | 30 | 1 | 1 |
