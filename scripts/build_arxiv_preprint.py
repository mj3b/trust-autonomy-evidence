...
def render_latex(lines: list[str]) -> str:
    output = [
        ...
        r"{\small " + latex_escape(STUDENT_STATUS) + r"\par}",
        ...
        r"{\footnotesize Independent work through Node \& Norm; no Harvard University sponsorship, supervision, endorsement, or representation.\par}",
        r"\vspace{0.75em}",
