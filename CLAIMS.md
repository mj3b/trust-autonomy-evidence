...
| TAE-C21 | Version 0.5 defines separate traceability, integrity, support, evidence-fitness, and dependency-closure gates for its declared claim set | Protocol, claim map, JSON Schema, and executable audit | Demonstrated as an artifact property | A gate is removed, merged, or no longer represented in the executable contract |
| TAE-C22 | The v0.5 audit detects all nine prespecified claim-map corruptions | Mutation fixture and generated audit result | Demonstrated for committed controls | Any controlled corruption escapes its expected integrity check |
| TAE-C23 | The v0.5 integrity audit establishes independent reliability or field validity | Author-designed claim map, judgments, controls, and implementation | Unsupported | An eligible independent study reproduces the judgments or tests the method in a relevant field setting |
| TAE-C24 | A failed or indeterminate required gate prevents a claim from supporting a conclusion under the v0.5 contract | Protocol rule, executable eligibility calculation, and blocked claims | Demonstrated as an artifact property | The audit permits an affected claim to become conclusion-eligible |
| TAE-C25 | The v0.5 fitness review fails contemporaneity for the stronger Oko protocol-consistency claim while preserving the released v0.3.0 assessment | Oko source manifest, PR #11 review, claim map, and release-manifest check | Demonstrated for the declared audit scope | Eligible contemporaneous evidence or a versioned protocol decision resolves `PAPER-BLOCKER-01` |
