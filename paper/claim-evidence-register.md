...
| C09 | The method produced traceable, bounded assessment states for the three selected packets. | Bounded inference | C02 through C08; [cross-case report](../reports/public-case-reconstruction-v0.3.0.md) | Provisionally supported | General validity across AI systems or institutions. |
