...
Forward citations & Proposition permissions & 0 & Locator-level review required \\
Direct queries & Screening decisions & 4 of 5 & One decision open \\
Recovery population & Retrieval outcomes & 107 of 1,087 & 980 outcomes open \\
Recovery population & Recovered-content decisions & 75 of 76 & One direct-query decision open \\
\bottomrule
\end{tabularx}
\begin{tablenotes}[flushleft]\footnotesize
\item These counts describe the frozen recovery workflow. They supply no close-source prevalence estimate for the 1,087-record population because 980 retrieval outcomes remain open.
\end{tablenotes}
\end{threeparttable}
\end{table}
