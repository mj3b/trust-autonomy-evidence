...
**Working checkpoint:** 0.11.0 direct-query retrieval candidate

**Next target:** Resolve two direct-query source limits, then retrieve the 102 forward-citation records

**Status:** Published v0.10.0 protocol checkpoint with the retained-source gate closed and the five-record direct-query retrieval tranche recorded in the working tree
...
| Practical human control paper | Author-screened v0.9.0 manuscript candidate, 60-source matrix, frozen formal search, selected-index citation chains, final 89-record decisions, a terminal decision for each of the 27 retained-close sources, a frozen 284-record risk sample, five direct-query retrieval outcomes, 23-proposition literature audit, reader edition, structured tables, ethical burden-of-proof argument, and provisional venue selection | Working manuscript; author and retained-source full-text gates closed; direct-query retrieval recorded with one screening decision open | Inaccessible-record review, authenticated searches, and ethics guidance complete; venue-formatted anonymous package passes review |
