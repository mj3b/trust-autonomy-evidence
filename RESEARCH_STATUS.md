...
| Publication figure set | Four main figures, two appendix figures, six derived CSV files, SVG and PNG outputs, and a deterministic freshness check | Unreleased package derived from existing artifacts | A paper draft uses the registered captions and preserves every interpretation boundary |
